...
test("normalized graph supports component CRUD, movement, parameters, connection cleanup, and reset", () => {
...
test("versioned local circuit library saves, loads, copies, deletes, and rejects damaged documents", () => {
  ...
  circuit = graph.addComponent(circuit, graph.createComponent("g", "ground", { x: 0, y: 0 }), "2026-08-24T00:01:00.000Z");
