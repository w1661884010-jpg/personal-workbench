      ...
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            answer: "\\(dx/dt=2\\)\\(\\delta(t)\\)−3δ(t−2)。平坦段导数为 0，只有跳变点留下冲激，强度等于跳变幅度、符号由跳变方向决定。"
          },
          {
        ...
        experiments: [
          ...
          },
          {
            ...
            steps: [
              ...
              "反例对照一：切到预设 (1,2)，分别记录峰值（\\(=\\mathrm{min} (w_1,w_2)\\)）与总面积（\\(=w_1\\)·w₂），说明二者为何不等。",
          ...
          },
          {
            ...
            steps: [
              ...
              "反例对照二：只把 T 从 2 增到 8，谱点从 17 个变成 65 个、明显变密，但 T·\\(c_k\\) 仍落在同一条包络 \\(\\operatorname{sinc} (f)\\) 上——谱线变密没有改变各次谐波的相对权重。",
              "用自己的话解释：为什么 \\(c_k\\) 随 T 增大而减小，而 T·\\(c_k\\) 却始终落在同一条固定包络上？"
            ],
            expected: "\\(T=2\\) 时 \\(|k/T|\\le 4\\) 有 17 个谱点、\\(T=8\\) 时有 65 个（含零系数）；所有谱点落在包络 τ·\\(\\operatorname{sinc} (\\tau f)\\) 上误差 \\(\\le 1e-10\\)；\\(T=4,k=2\\) 时 \\(c_2=1/(2\\pi )\\)；\\(T=4,N=101\\) 时 \\(|x_N(0)-1|\\le 0.02\\)；\\(T=2,N=101\\) 跳变内侧过冲落在 8.8%–9.2%；MSE 按一个周期 4096 个中点等权计算。",
        ...
        check: [
          ...
          },
          {
            ...
            prompt: "正弦信号 \\(\\cos (2\\pi\\)·50t) 的频率与角频率分别是：",
            options: ["50 Hz 与 100π rad/s", "100π Hz 与 50 rad/s", "50 Hz 与 50 rad/s", "两者数值相同"],
            answer: 0,
            explanation: "一般式 \\(\\cos (\\omega t)\\) 中 \\(\\omega =2\\pi\\)·\\(50=100\\pi\\) rad/s，对应频率 \\(f=\\omega /2\\pi =50\\) Hz。"
          },
          {
          ...
          },
          {
            ...
            options: ["\\(x(t)\\)", "\\(x(t-t_0)\\)", "\\(x(t_0)\\)", "\\(x(t)\\)·δ(t−t₀)"],
            answer: 1,
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            pitfalls: [
              ...
              "只按 2\\(f_{\\max}\\) 机械取采样率，不给抗混叠滤波器的过渡带留余量"
            ],
            links: [
            ...
            variables: [
              ...
              "\\(f_s/2\\)：折叠频率（奈奎斯特频率）",
              "2\\(f_{\\max}\\)：奈奎斯特率；等号不保证唯一恢复，须排除折叠频率上的端点分量"
            ]
          },
          {
          ...
          },
          {
            ...
            points: [
              ...
              "\\(\\omega =\\pi\\) 对应折叠频率 \\(f_s/2\\)；物理频率 \\(= \\omega\\)·\\(f_s\\)/(\\(2\\pi\\))"
            ],
            pitfalls: [
          ...
          },
          {
            ...
            detail: [
              ...
              "验证点：取 \\(x=[1 1 1 1]\\)（宽度 4 的矩形）与 \\(h=[1 1]\\)（宽度 2），conv 得到 \\([1 2 2 2 1]\\)，长度 \\(4+2-1=5\\)，峰值 \\(2 = \\mathrm{min} (4,2)\\)，总和 \\(8 = 4\\)×2——与第一节“峰值取较短者、总面积等于两者面积之积”的结论逐条对上。再用频域路径核对：`yf=ifft(fft(x,8).*fft(h,8))`，前 5 点应与 conv 结果一致（容差 1e-10），后 3 点应近零。",
            ...
            points: [
              ...
              "验证点：\\(x=[1 1 1 1]\\)、\\(h=[1 1] \\to [1 2 2 2 1]\\)，峰值 \\(2=\\mathrm{min} (4,2)\\)，总和 \\(8=4\\)×2",
          ...
          },
          {
            ...
            detail: [
              ...
              "验证点：取 \\(fs=1000\\) Hz、\\(x=\\cos (\\)\\(2\\pi\\)·100·t)，\\(N=1000\\) 点，fft 后峰值应出现在 \\(k=100\\) 处，换算成 \\(f=100\\) Hz；把 N 改成 100（记录时间 0.1 s），分辨率降到 10 Hz，峰仍然读得到 100 Hz，但相邻频点间距从 1 Hz 变成 10 Hz——直接演示 \\(\\Delta f=f_s/N\\)。",
        ...
        examples: [
          ...
          },
          {
            ...
            steps: [
              "换算关系是 \\(f=\\omega\\)·fs/(\\(2\\pi\\))。",
              "\\(\\omega =0.5\\pi\\) 时 \\(f=0.5\\pi\\)×8000/(\\(2\\pi\\)\\()=2000\\) Hz。",
              "\\(\\omega =\\pi\\) 时 \\(f=\\pi\\)×8000/(\\(2\\pi\\)\\()=4000 Hz=fs/2\\)，正是折叠频率。"
            ],
          ...
          },
          {
            ...
            steps: [
              "直接 DFT 约 \\(N^2=1024^2\\approx 1.05\\)×10⁶ 次。",
              "基2 FFT 约 \\((N/2)\\log _2N=512\\)×\\(10=5.1\\)×10³ 次。",
          ...
          },
          {
            ...
            answer: "\\(y=[1 2 2 2 1]\\)，定义在 \\(n=0\\)…4；峰值 \\(2=\\mathrm{min} (4,2)\\)，总和 \\(8=4\\)×2。"
          },
          {
            title: "读单边幅度谱",
        ...
        check: [
          ...
          },
          {
            ...
            answer: 1,
            explanation: "\\(f=\\omega\\)·fs/(2π)，\\(\\omega =\\pi\\) 时 \\(f=fs/2=4\\) kHz，即折叠频率。"
          },
          {
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            detail: [
              "两个反例最能说明“逐项判断”的必要。其一 \\(y[n]=n\\)·\\(x[n]\\)：它满足线性和无记忆，也是因果的，但含显式时间系数所以时变；更关键的是取 \\(x[n]\\)≡1（有界），输出 \\(y[n]=n\\) 在 n 遍历全部整数时无界，因此不是 BIBO 稳定。其二 \\(y[n]=(x[n])^2\\)：它不是线性（\\(T{2x}=4y\\ne 2T{x}\\)），但时不变、因果、无记忆，且 \\(|x|\\le 1\\) 时 \\(|y|\\le 1\\)，是 BIBO 稳定的。可见“线性”“稳定”“因果”“可逆”彼此不能互推。",
          ...
          },
          {
            ...
            detail: [
              "舍入量化模型：把步长 Δ 的均匀量化写成 \\(Q(x)=\\Delta\\)·\\(round(x/\\Delta )\\)。只要不发生溢出，误差满足 \\(|Q(x)-x|\\le \\Delta /2\\)——这是确定性的界，对每个样本都成立，不需要任何统计假设。位数每增加 1 位，Δ 减半，误差上界也随之减半（约 6 dB）。",
            ...
            points: [
              "舍入量化 \\(Q(x)=\\Delta\\)·\\(round(x/\\Delta )\\)：无溢出时 \\(|Q(x)-x|\\le \\Delta /2\\)（确定性界，不含统计假设）",
        ...
        examples: [
          ...
          {
            title: "逐项检验两个系统",
            prompt: "判断 \\(y[n]=n\\)·\\(x[n]\\) 与 \\(y[n]=(x[n])^2\\) 的线性、时不变、因果、无记忆与 BIBO 稳定性。",
            steps: [
            ...
            answer: "\\(y=n\\)·x：线性、时变、无记忆、因果、非稳定；\\(y=x^2\\)：非线性、时不变、因果、无记忆、稳定。"
          },
          {
            title: "一阶离散系统的全响应",
        ...
        check: [
          ...
          },
          {
            ...
            options: ["\\(A \\cos (\\omega _0n+\\varphi )\\)", "\\(A|H|\\cos (\\omega _0n+\\varphi +\\)∠H)", "\\(|H|\\cos (\\omega _0n)\\)", "A/H·\\(\\cos (\\omega _0n)\\)"],
            answer: 1,
          ...
          },
          {
            ...
            prompt: "舍入量化 \\(Q(x)=\\Delta\\)·\\(round(x/\\Delta )\\) 在无溢出时的误差满足？",
        ...
        summary: [
          "系统性质逐项检验：线性、时不变、因果、无记忆、BIBO 稳定、可逆彼此不可互推（\\(y=n\\)·x 与 \\(y=x^2\\) 是两个反例）。",
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            detail: [
              "切比雪夫多项式在 \\(|x|\\le 1\\) 时满足 \\(T_N(x)=\\cos (N\\)·arccos x)，在 \\([-1,1]\\) 内等幅振荡于 ±1；在 |x|>1 时 \\(T_N(x)=cosh(N\\)·arcosh x) 快速增长。这两段行为正好对应滤波器的两个频段：通带内 |H| 在 1 与 1/√(1+ε²) 之间等波纹起伏，阻带内则快速下降。纹波量由 ε 唯一决定：\\(Ap=10lg(1+\\varepsilon ^2)\\)，即 \\(\\varepsilon =\\sqrt (10^{Ap/10}-1)\\)。\\(Ap=1\\) dB 时 \\(\\varepsilon =0.5088\\)，通带内 |H| 在 0.8913 与 1.0000 之间起伏，在 \\(\\Omega =\\Omega c\\) 处恰好为 −1.0000 dB。",
          ...
          },
          {
            ...
            detail: [
              "冲激响应不变法：令 \\(h[n]=T\\)·\\(h_a(nT)\\)，则数字极点 \\(z=e^{s_{kT}}\\) 由模拟极点映射而来。映射把左半平面映到单位圆内，因此原型稳定则数字滤波器稳定。问题是时域采样对应频域周期延拓，若模拟响应在折叠频率以上衰减不够，混叠就会破坏阻带指标——所以它不适合高通与带阻，只适合带限的低通/带通。",
        ...
        examples: [
          ...
          },
          {
            ...
            steps: [
              "时间常数 \\(RC=10^4\\)×\\(10^-8=10^-4\\) s。",
              "\\(fc=1/(2\\pi RC)=1/(2\\pi\\)×\\(10^-4)\\approx 1591.5\\) Hz，该点 \\(|H|=1/\\sqrt 2\\)。",
          ...
          },
          {
            ...
            steps: [
              ...
              "\\(\\omega p=2\\pi\\)×\\(100/1000=0.2\\pi\\) rad；\\(\\omega s=2\\pi\\)×\\(200/1000=0.4\\pi\\) rad。",
          ...
          },
          {
            ...
            steps: [
              ...
              "代入 \\(\\omega =0.4\\pi\\)：\\(\\tan (0.2\\pi )=0.7265\\)，\\(\\Omega p=(2/10^-3)\\)×\\(0.7265=1453.085\\) rad/s。",
        ...
        check: [
          ...
          },
          {
            ...
            answer: 1,
            explanation: "\\(fc=1/(2\\pi RC)=1/(2\\pi\\)×\\(10^-4)\\approx 1591.5\\) Hz；该点 \\(|H|=1/\\sqrt 2\\)。"
          },
          {
            ...
            answer: 1,
            explanation: "\\(\\omega =2\\pi f/fs=2\\pi\\)×\\(100/1000=0.2\\pi\\) rad；数字指标必须落在 \\(0\\le \\omega \\le \\pi\\)。"
          },
          {
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            detail: [
              "核心结论：\\(S_y(e^{j\\omega })=|H(e^{j\\omega })|^2S_x(e^{j\\omega })\\)；若输入是方差 \\(\\sigma _x^2\\) 的白噪声，则 \\(S_x\\) 为常数 \\(\\sigma _x^2\\)，于是输出方差 \\(R_y(0)=(\\sigma _x^2/2\\pi )\\int |H(e^{j\\omega })|^2d\\omega =\\sigma _x^2\\Sigma _k|h[k]|^2\\)。最后这个式子最好用：白噪声通过任何 FIR 滤波器，输出方差等于输入方差乘以系数平方和。算例：方差 9 的白噪声通过三点移动平均 \\(b=[1/3,1/3,1/3]\\)，\\(\\Sigma b^2=3\\)×\\((1/3)^2=1/3\\)，输出方差 9×\\(1/3=3\\)（数值验证 3.0053）；通过 5 点移动平均则 \\(\\Sigma b^2=1/5\\)，输出方差降到 1.8。",
            ...
            points: [
              ...
              "白噪声输入时输出方差 \\(= \\sigma _x^2\\)·\\(\\Sigma |h[k]|^2\\)（用系数平方和直接算）",
              "算例：\\(\\sigma ^2=9\\) 经 3 点移动平均 → 方差 3；经 5 点移动平均 → 方差 1.8",
              "输出相关函数 \\(= \\sigma _x^2\\)·\\((h*h_{rev})\\)，可用于由相关函数反推冲激响应（相关法辨识）"
            ],
            pitfalls: [
          ...
          },
          {
            ...
            detail: [
              "LMS（最小均方）算法：\\(w[n+1]=w[n]+\\mu\\)·\\(e[n]\\)·\\(x[n]\\)，其中 \\(e[n]=d[n]-w\\)ᵀ\\([n]x[n]\\) 是瞬时误差，μ 是步长。它的做法是用瞬时误差平方的梯度替代真实均方误差的梯度（后者需要统计期望）。收敛的充分条件是 0<μ<2/(N·\\(P_x)\\)（\\(P_x\\) 为输入功率，N 为抽头数）：μ 太小收敛慢，太大则不收敛或稳态失调变大——步长是自适应滤波里最关键的参数。数值验证：两抽头、输入方差 9、目标系数 \\([0.8, -0.5]\\)、\\(\\mu =0.01\\) 时，运行 20 万点后权向量收敛到 \\([0.796, -0.489]\\)，与目标一致。",
            ...
            points: [
              "LMS 更新式：\\(w[n+1]=w[n]+\\mu\\)·\\(e[n]\\)·\\(x[n]\\)，\\(e[n]=d[n]-w\\)ᵀ\\([n]x[n]\\)",
          ...
          },
          {
            ...
            detail: [
              ...
              "验证点：\\(\\sigma =3\\)、\\(N=2\\)×10⁵ 时，样本均值应落在 0 附近、样本方差应落在 9 附近，但都不会正好等于理论值——这是有限样本的统计波动，不是代码错误。量级可以预先算出来：均值估计的标准差约 \\(\\sigma /\\sqrt N\\approx 0.0067\\)，因此均值通常落在 ±0.02（约 3σ）内；方差估计的相对标准差约 \\(\\sqrt (2/N)\\approx 0.32%\\)，对应绝对偏差约 ±0.09。若实测偏差明显超过这个范围，先怀疑随机数发生器的质量（简单线性同余发生器在 2×10⁵ 样本上就可能让方差偏高百分之一点几（本次复算实测偏高 1.7%）），而不是先怀疑公式。教学结论：报统计量时必须同时给出样本量与置信范围。"
            ],
            points: [
              "rng 固定种子保证可复现；randn 生成正态样本，乘 σ 设方差",
              "var 默认无偏（除以 N−1）；xcorr 的 'biased'/'unbiased' 决定是否除以 N",
              "验证点：\\(\\sigma =3\\)、\\(N=2\\)×\\(10^5 \\to\\) 均值标准差 \\(\\approx \\sigma /\\sqrt N\\approx 0.0067\\)、方差相对标准差 \\(\\approx \\sqrt (2/N)\\approx 0.32%\\)，实测偏差应落在这个量级内",
          ...
          },
          {
            ...
            detail: [
              ...
              "验证点：对白噪声，单段周期图的曲线会在真值附近剧烈起伏（起伏幅度不随记录长度减小），而分段平均后的曲线明显平滑并收敛到平坦的 σ²；把信号换成白噪声通过 3 点移动平均滤波器的输出，估计出的谱形状应等于 \\(|\\sin (3\\omega /2)/(3\\sin (\\omega /2))|^2\\)×σ²，在 \\(\\omega =0.5/1.0/1.5/2.0\\) 处实测比值 0.846/0.488/0.158/0.003 与理论 0.843/0.481/0.145/0.003 逐点吻合。"
            ],
            points: [
              "pwelch 分段平均；periodogram 单段周期图；cpsd/mscohere 用于互谱与相干",
              "单段周期图方差大且不随记录长度减小，分段平均用偏差换方差",
              "验证点：白噪声经 3 点移动平均 → 输出谱形状 \\(= |H|^2\\)·σ²",
        ...
        examples: [
          ...
          },
          {
            ...
            steps: [
              ...
              "核对：\\(R_x(0)=1\\)；\\((1/2\\pi )\\int 2a/(a^2+\\omega ^2)d\\omega =(1/2\\pi )\\)×\\(2\\pi =1\\)，一致。",
          ...
          },
          {
            ...
            steps: [
              "输出功率 \\(= (1/2\\pi )\\int |H|^2S_x d\\Omega = (N_0/2)\\)·(1/2π)∫dΩ/(1+(Ω/Ωc)²)。",
              "积分 \\(\\int _{-\\infty }^{\\infty }d\\Omega /(1+(\\Omega /\\Omega c)^2)=\\pi \\Omega c\\)。",
              "结果 \\(= (N_0/2)\\)·\\((\\pi \\Omega c/2\\pi )=N_0\\Omega c/4\\)。"
            ],
          ...
          },
          {
            ...
            steps: [
              ...
              "3 点：\\(\\Sigma h^2=3\\)×\\((1/3)^2=1/3\\)，输出方差 9×\\(1/3=3\\)。",
              "5 点：\\(\\Sigma h^2=5\\)×\\((1/5)^2=1/5\\)，输出方差 9×\\(1/5=1.8\\)。"
            ],
          ...
          },
          {
            ...
            steps: [
              ...
              "消去 P、P⁻ 得稳态标量 Riccati 方程 \\(K^2R+QK-Q=0\\)（等价 \\(P^2+PQ-RQ=0\\)）；代入 \\(Q=10^-4\\)、\\(R=1\\) 解得 \\(K=(-10^-4+\\sqrt (10^-8+4\\)×\\(10^-4))/2\\approx 0.00995\\)。",
          ...
          },
          {
            ...
            steps: [
              ...
              "步长需满足充分条件 0<μ<2/(N·\\(P_x)\\)，N 为抽头数：两抽头时 0<μ<2/(2×\\(9)\\approx 0.111\\)，0.01 在范围内。注意这是充分条件而不是精确的发散阈值。",
          ...
          },
          {
            ...
            steps: [
              ...
              "取采样率 100 Hz（\\(\\Delta =0.01\\) s）、目标 \\(f=20\\) Hz：\\(a=0.8125/(20\\)×\\(0.01)=4.06\\)。",
          ...
          },
          {
            ...
            steps: [
              "路径一（系数平方和）：\\(\\sigma _x^2\\Sigma b^2=9\\)×\\((1/3)=3\\)。",
        ...
        check: [
          ...
          },
          {
            ...
            answer: 1,
            explanation: "对卷积取期望即得 \\(\\mu _y=\\mu _x\\int h dt=\\mu _x\\)·\\(H(0)\\)，即被直流增益缩放。"
          },
          {
            ...
            options: ["9", "3", "1", "1.8"],
            answer: 1,
            explanation: "\\(\\sigma _y^2=\\sigma _x^2\\Sigma h^2=9\\)×(3×\\((1/3)^2)=9/3=3\\)；5 点移动平均则为 1.8。"
          },
          {
