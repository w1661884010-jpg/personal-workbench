      ...
      sections: [
        {
          ...
          importance: "core",
          sourceStatus: "insufficient",
          content: "教材包含随机过程、样本函数、均值、方差和相关函数；但本地没有对应章节课件。完成课程范围确认前，本节只保留教材导航和可核对的基础关系。",
        ...
        },
        {
          ...
          importance: "core",
          sourceStatus: "insufficient",
          content: "对宽平稳随机过程，功率谱密度与自相关函数构成傅里叶变换对。该关系用于从统计相关性解释频率上的平均功率分布。",
          formula: "Sx(ω)=F{Rx(τ)}",
        ...
        },
        {
          ...
          importance: "core",
          sourceStatus: "insufficient",
          content: "宽平稳输入通过稳定 LTI 系统后，输出功率谱由输入谱乘以 |H|² 得到。需要区分单次波形响应和统计量响应。",
        ...
        },
        {
          ...
          importance: "core",
          sourceStatus: "insufficient",
          content: "教材列出维纳、卡尔曼和自适应滤波。当前仅保留它们分别面向平稳估计、状态递推估计和未知环境在线调整的定位，详细推导等待课程范围确认。",
        },
        {
          ...
          importance: "optional",
          sourceStatus: "insufficient",
          content: "时频分析、小波与希尔伯特—黄变换依赖更多先修知识，且缺少本课程配套课件，统一标为选择学习，不写成当前教学既定内容。",
        },
      ],
      examples: [
        {
